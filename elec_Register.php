...
if(isset($_POST['submit'])=="REGISTER")
{
    ...
    if($valid==true)
    {
        ...
        $experience_dur = $conn->real_escape_string($_POST["experience_dur"]);

        $sql = $conn->prepare("SELECT * FROM electrician WHERE username= ?");
        ...
        if($success =="false")
        {
            $sql="INSERT INTO electrician (f_name,l_name,address,city,postcode,u_state,hp,qualification, exper_duration, email,username,password) VALUES
            ('$fName','$lName', '$address','$city','$postcode','$state','$hp','$qualification','$experience_dur','$email','$username','$password')";
...
<div class="background">
    ...
    <div class="container">
        <form class="form-inline " method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" id="register_form">
            <h1 style="margin-top: 20px; color: white;">Sign Up as Electrician...</h1>
            ...
            <div class="row">
                ...
                <div class="col-75">
                    <input type="text" name="qualification" id="qualification" placeholder="QUALIFICATION" value="<?php echo isset($_POST['qualification']) ? $_POST["qualification"]: ' ';?>">
                </div>
            </div>

            <div class="row">
                <div class="col-25">
                    <label for="experience_dur">Experience Duration: </label>
                </div>
                <div class="col-75">
                    <input type="text" name="experience_dur" id="experience_dur" placeholder="EXPERIENCE DURATION" value="<?php echo isset($_POST['experience_dur']) ? $_POST["experience_dur"]: ' ';?>">
                </div>
            </div>
            ...
            <h4 style="color: white;">I'm an Employer .<a href="emp_Register.php">Register</a> as a Employer
